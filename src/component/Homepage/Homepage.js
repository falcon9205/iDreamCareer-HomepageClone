...
const Homepage = () => {
  ...
  return (
    ...
    >
      {/* Hero section */}
      <section  data-aos="fade-up" className="md:flex  items-center space-y-10 md:space-y-0 justify-between">
      ...
      {/* know our ecosystem */}
      <section  data-aos="fade-up" className="space-y-10 md:space-y-20">
      ...
      {/* About us */}
      <section  data-aos="fade-up" className=" mt-44 space-y-10 md:space-y-20">
      ...
      {/* impact we made */}
      <section  data-aos="fade-up" className="mb-20 mt-44 space-y-20">
      ...
      {/* Technology led  */}
      <section  data-aos="fade-up" className="mb-20 mt-44 space-y-20 bg-blue-100 py-5 rounded-2xl">
      ...
      {/* Empowering schools */}
      <section  data-aos="fade-up" className="mb-20 mt-44 space-y-20 rounded-2xl">
        ...
        <div className="md:flex space-y-10  items-center">
          <div className="md:w-1/2 space-y-5">
            ...
            <p className="md:text-lg text-gray-600">
              We work with forward thinking private schools to enhance their
              career guidance capacities to make sure that their students stay
              ahead of time.
            </p>
            <button className="bg-blue-500 flex items-center gap-x-1 text-white px-4 rounded-sm py-1 hover:gap-x-3 hover:bg-blue-700 text-lg transition-all duration-200 ease-in">
              Know More{" "}
      ...
      <section  data-aos="fade-up" className=" mt-44 space-y-20 px-[5%] pb-20">
